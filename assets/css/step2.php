        ...
        $.ajax({
            ...
            success: function(data) {
               ...
               // $("#bgcolor").css('left', 41);
                ...
                $(".coincorner").css('margin-top', '-3px');
                $("#floatCurveText").css('margin-top', '-3px');
                $("#floatCurveTextBottom").css('margin-top', '-3px');
        ...
        updateBottom: function (dir) {
            ...
            if(false){ // For capital letters Top text
                ...
                **/
                ...
                size = 26;
                text = '<p id="bottomCurvedText" style="margin-bottom: 0; margin-top:'+marginTop+';letter-spacing:'+ltrSpacing+'">' + $('#cointext').val().toUpperCase() + '</p>';
                console.log('now text capital'+text);
            }
            console.log('radius: '+radius);
            /*Check for font a get radious then */
          ...
          //  console.log('Text: '+toptextnew);
            ...
            if(false){ // For capital letters Top text
                ...
                **/
                ...
                size = 26;
                text = '<p id="bottomCurvedText" style="margin-bottom: 0; margin-top:'+marginTop+';letter-spacing:'+ltrSpacing+'">' + bottomtextnew1.toUpperCase() + '</p>';
                console.log('now text capital'+text);
            }
            console.log('radius: '+radius);
            /*Check for font a get radious then */
