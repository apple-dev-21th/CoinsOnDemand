  ...
  foreach ($category as $catg) { ?>
                ...
                //    echo '<pre>'; print_r($template);
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-3 text-center coins_cat">
                            <div class="coin_img">
                                <a href="javascript:void(0)" type="submit" onclick="createsession(<?php echo $coin['coin_id']; ?>)"> <img src="<?php echo base_url() ?>assets/uploads/<?php echo $coin['coin_image']; ?>" alt=""> </a></div>
<!--                            <p class="review_text"><?php echo $coin['coin_name']; ?><br><span class="coin_price">$<?php echo $coin['coin_price']; ?></span></p>-->
                            <a href="javascript:void(0)"class="btn submit_btn mar_top_0 p_coin" type="submit" onclick="createsession(<?php echo $coin['coin_id']; ?>)">Personalize this coin </a>
                        </div>
                    <?php if ($i % 4 == 0) {
                            echo ' </div>
...
<!--        <div class="col-lg-3 col-md-3 col-xs-3">
            <div class="panel panel-default">
                <div class="panel-heading">Choose a category</div>
                <div class="panel-body">
                    <ul class="nav nav-pills nav-stacked faq" style="max-width: 300px;">
<?php // foreach ($category as $catg) { ?>
                            <li <?php // if ($id == $catg['id']) echo 'class="active"'; ?>><a href="<?php //echo base_url(); ?>select_template/index/<?php // echo $catg ['id']; ?>"><?php  //echo $catg['category_name']; ?></a></li>
<?php // } ?>
                    </ul>
                </div>
            </div>
...
function getcoins(id){
    window.location.href="<?php echo base_url().'select_template/index/';?>"+id;
}
</script>
