...
<div style="display: none">
    <img src="<?php echo base_url(); ?>assets/images/Processing_animateSE.gif" >
</div>
...
<style>
    ...
    .activeBtn{
        ...
        ?>
        	.mydivnew_processing{
            	background: url("<?php echo base_url(); ?>/assets/images/Processing_animateSE.gif") no-repeat scroll center center rgba(0, 0, 0, 0) !important;
		        height: 100%;
		        position: absolute;
		        width: 100%;
		        z-index: 100;
	        ...
	        .mydivnew {
				...
				z-index: 100;
				position: absolute;
				background: url(../../assets/img/silver-eagle-rim-larger.png) center center no-repeat !important;
			}
			...
			.coincorner {
				height: 355px !important;
				width: 355px !important;
				background-size: 355px 355px !important;
				top: 3px !important;
				left: 0px !important;
			}
        ...
        ?>
           ...
           .mydivnew_processing{
            	background: url("<?php echo base_url(); ?>/assets/images/Processing_animate.gif") no-repeat scroll center center rgba(0, 0, 0, 0) !important;
		        height: 100%;
		        position: absolute;
		        width: 100%;
		        z-index: 100;
    ...
    .n7_img_preload {
        ...
        height: 0px;
        display: inline;
        background-image: url("<?php echo base_url(); ?>/assets/images/coinout_processing.png");
    }
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#dyn_img img").load(function() {
            $("#test").css('width', $('#test').clientWidth+'px');
            $("#test").css('height', $('#test').clientHeight+'px');
        }) 
    });
    ...
    function changecolor() {
        ...
        $('.backpreview').attr('style', 'background-color: '+color+' !important;');
    }
    ...
    <div class="leftcont">
        <div class="glossymenu">
            ...
            <div class="submenu second1 open" contentindex="1c" style="display: none;">
                <select  name="category" class="theme" id="category" onchange="gettemplate(this.value)" style="border: 1px solid #3E3E3C; color: #3E3E3C;">
                ...
                <select class="theme" name="coinbgcolor" id="coinbgcolor" onchange="changecolor()" style="border: 1px solid #3E3E3C; color: #3E3E3C;">
                ...
                <div class="clearfix"></div>
                <div class="zoom" style="border: 1px solid #3E3E3C;"> <a id="out" href="javascript:void(0)"></a> <span style="color: #3E3E3C;">Zoom</span> <a href="javascript:void(0)" id="in"></a> </div>
                &nbsp;
                <div class="zoom" style="float:right; border: 1px solid #3E3E3C;"> <a id="rin" href="javascript:void(0)"></a> <span style="color: #3E3E3C;">Rotate</span> <a href="javascript:void(0)" id="rout"></a> </div>
                <div class="clearfix"></div>
                <div class="clearfix"></div>
                <div class="addtext">
                    <h4 style="color: #3E3E3C;"><font>Add Text</font>  <span style="font-size:12px;">(Text will appear in uppercase)</span></h4>
                    <textarea id="cointext"  maxlength="30" data-limit-input="30" style="border: 1px solid #3E3E3C;"></textarea>
                    <span>0 of 30 characters used</span> </div>
                <div class="forcolm">
                    <input type="button" id="upTextBtn" class="one" value="Top of Circle" onclick="writetop()" style="border: 1px solid #3E3E3C; color: #3E3E3C;">
                    <input type="button"  id="downTextBtn" class="second" value="Bottom of Circle" onclick="writebottom()" style="border: 1px solid #3E3E3C; color: #3E3E3C;">
                    <select class="choosefont" name="changefont" id="changefont" onchange="changefont()" style="border: 1px solid #3E3E3C; color: #3E3E3C;">
                        <option>Fonts</option>
                    ...
                    <select class="fontcolor" name="fontcolor" id="fontcolor" onchange="fontcolor()" style="border: 1px solid #3E3E3C; color: #3E3E3C;">
                    ...
                    <select class="choosefont" name="outlinecolor" id="outlinecolor" onchange="outlinecolor()" style="border: 1px solid #3E3E3C; color: #3E3E3C;">
    ...
    <div class="rightcont">
        <div class="wrapper fullsizeofimagesave" style="position:relative;">
            <div class="inpreview" style="position: relative; height:430px; text-align: center;" id="mydiv">
                ...
                <div id="bgcolor" style="position: relative;">
                    <div id="dyn_img"> </div>
            ...
            <div class="row" style="position: absolute; z-index:1000; top:0px; left:0px; width:203px !important;">
                <div class="col-md-12 pull-left "> <a class="replace" href="<?php echo base_url(); ?>personalizedcoin/step1/<?php echo $coin_type?>" onclick="saveimgstyle()"></a> <a class="startover" href="javascript:;" onclick="restfunction()"></a>
...
?>
        ...
        $("[name=mydivnew]").removeClass('mydivnew');
        var imageX = $("#test").attr('left');
        var imageY = $("#test").attr('top');
        var imageRotate = transaformImageSize;
        var imageSource = $("#test").attr('src');
        /*imageSource = imageSource.replace('http://www.coinsondemand.com/', 'http://216.172.184.99/~ab87757/');*/
        var color = document.getElementById('coinbgcolor').value;
...
//                    logging:true,
                    ...
                    onrendered: function(canvas) {
                        ...
                        var coin_type = '<?php echo $coin_type; ?>';
                        var Parameters = "image=" + output + '&coin_type=' + coin_type;
                        $.ajax({
                            type: "POST",
                            ...
                            success: function(data) {  // Store final image to session
                                ...
                                $.ajax({
                                    ...
                                    success: function(data) {
                                        ...
                                        window.location.href = "<?php echo base_url(); ?>" + 'personalizedcoin/step3/<?php echo $coin_type; ?>';
                                    }
